...
import { getPaymentSummary } from "../../../../server/dashboard";
...
export async function GET(request) {
  ...
  try {
    ...
    console.error("GET /api/dashboard/pagos:", error);
    return errorResponse("Error al consultar el resumen de pagos", 500);
  }
}
